...
class Recognizer{
    ...
    start(point, context) {
        // console.log('start')
        this.dispatchtor.dispatch('start', {
    ...
    move(point, context){
        // console.log('move', context.startX, context.startY, point.clientX, point.clientY)
        ...
        // console.log('dispach end')
        this.dispatchtor.dispatch('end', {
            startX: context.startX,
            startY: context.startY,
            clientX: point.clientX,
            clientY: point.clientY,
